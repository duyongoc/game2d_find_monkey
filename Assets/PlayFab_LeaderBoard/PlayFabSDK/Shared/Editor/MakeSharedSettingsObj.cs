...
public class MakeScriptableObject
{
    ...
    public static void MakePlayFabSharedSettings()
    {
        ...
        AssetDatabase.CreateAsset(asset, "Assets/PlayFab_LeaderBoard/PlayFabSdk/Shared/Public/Resources/PlayFabSharedSettings.asset"); // TODO: Path should not be hard coded
